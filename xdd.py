...
while coinp1<5 and coinp2<5 :
    ...
    if coin==1:
        ...
        coinp2+=1
if coinp1>coinp2:
    print(player_1,"le volo la raja a ", player_2, "con un puntaje total de",coinp1,"-",coinp2)
else:
    print(player_2,"le volo la raja a ", player_1,"con un puntaje total de",coinp2,"-",coinp1)